...
namespace FixingIsOneWay.Test
{
	internal static class TestHelpers
	{
		...
		{
			return await TestHelpers.GetDiagnosticsAsync(code,
		...
		internal static Document CreateDocument(string code)
		{
			...
			var solution = new CustomWorkspace()
				 ...
				 .AddMetadataReference(projectId,
					new MetadataFileReference(typeof(OperationContractAttribute).Assembly.Location, MetadataImageKind.Assembly));
